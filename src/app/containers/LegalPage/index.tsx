    ...
    <>
      <Container className="mt-4">
        ...
        <Container className="homepage-container" fluid>
          <Row>
            <Col md="12" className="info-box">
              ...
              <p>
                ...
                <br />
                E-Mail: abuse (at) tomstein (dot) me
              </p>
              <p>
          ...
          <Row>
            <Col md="12" className="info-box">
              <h5 className="info-header">Datenschutzerklärung</h5>
              ...
              <p></p>
              <b>Registrierung auf unserer Website</b>
              ...
              <p></p>
              <p>
                Ihre Registrierung ist für das Bereithalten bestimmter Inhalte
              ...
              <p>
                ...
                Bereitstellung Ihrer personenbezogenen Daten können wir Ihnen
              ...
              <b>Einzelfallbezogenes Widerspruchsrecht</b>
              <p>
              ...
              <b>Empfänger eines Widerspruchs</b>
              <p>Tom Stein</p>
              <b>Änderung unserer Datenschutzbestimmungen</b>
              <p>
